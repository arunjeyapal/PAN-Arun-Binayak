...
public class GenerateARFF1 {
	...
	public static void generateARFF(String pairs, String klass)
		...
		saver.setFile(new File("./test5.arff"));
		saver.setDestination(new File("./test5.arff"));
		saver.writeBatch();
	...
	public static void main(String args[]) throws IOException {
		generateARFF(
				"/home/arunjayapal/Public/PANCompetition/docs/pan12-detailed-comparison-training-corpus/02_no_obfuscation/pairs.txt",
				"no_plagiarism");
	}
}