...
public class GenerateARFF2 {
	...
	public static void generateARFF(String pairs, String klass)
		...
		saver.setFile(new File("./test4.arff"));
		saver.setDestination(new File("./test4.arff"));
		saver.writeBatch();
	...
	public static void main(String args[]) throws IOException {
		generateARFF(
				"/home/arunjayapal/Public/PANCompetition/docs/pan12-detailed-comparison-training-corpus/03_artificial_low/pairs",
				"no_plagiarism");
	}
}